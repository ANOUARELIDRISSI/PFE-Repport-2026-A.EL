...
This chapter first established the concepts required to understand retrieval-augmented and graph-based generation. It then reviewed classical RAG, knowledge-graph construction, Graph-RAG strategies, reasoning methods, political and temporal NLP, and evaluation principles. The examination of classical RAG, Microsoft GraphRAG, Neo4j-based retrieval, Wikidata, and GDELT showed that existing solutions provide complementary capabilities but do not jointly guarantee continuous ingestion, explicit provenance, multilingual and temporal analysis, adaptable reasoning, and auditable synthesis. These limitations define the research position of the proposed work. Chapter~3 combines the requirements established in Chapter~1 with the foundations and research gap identified here to define the system architecture.
