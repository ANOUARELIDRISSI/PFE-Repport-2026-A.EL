...
Table~\ref{tab:requirements-validation} links the evaluation evidence to the principal requirements defined in Chapter~1. It separates functional verification from quality measurement so that the final validation does not rely only on aggregate RAGAS scores.
