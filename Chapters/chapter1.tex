...
The project scope covers the complete workflow from autonomous acquisition of public political documents to grounded question answering over a hybrid vector and graph store. The initial corpus targets \textbf{57 distinct and expandable international sources}, with ingestion extended through RSS monitoring, news discovery guided by queries, direct URL submission, and PDF report parsing. Out of scope for the core deliverable are proprietary closed datasets unavailable for ingestion, real time social media firehose processing at web scale, and fully automated judgment of legal or normative correctness beyond synthesis supported by evidence.
...
This chapter presented the institutional context of the internship and showed how SCIENTIAE's need for a reusable Graph-RAG framework leads to the political and geopolitical validation domain. It then derived the problem statement, solution objectives, actors, UML views, functional and non-functional requirements, technology choices, project-management approach, and validation criteria. Chapter~2 now reviews the state of the art that supports these choices before Chapter~3 translates the requirements into system architecture and component responsibilities.
